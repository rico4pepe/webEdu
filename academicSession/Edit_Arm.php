...
$arms_id = $arms_name = null;
$id = $_GET['id'];
$users_query  = $conn->query("SELECT arms_id, arms_name FROM `arms` where arms_id = '$id'");
$users_row = $users_query ->fetch((PDO::FETCH_ASSOC));

$arms_id = $users_row['arms_id'];
$arms_name = $users_row['arms_name'];
							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
										...
										$Arm->updateArm($armName,$arms_id );
                                    }
                        ?>
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Arms</label>
                                            <input  class="form-control form-control-lg form-control-solid" type="text" name="armName" value="<?php echo $arms_name; ?>" autocomplete="off">
