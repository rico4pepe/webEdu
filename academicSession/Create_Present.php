					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Present Academic Year</label>
                                        ...
                                        <div class="col-xl-6">
										<input type="submit" name="btn" class="btn btn-lg btn-primary" value="Activate Session and Term"  />
