...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Web Edu - A School Management Application</title>
		<meta charset="utf-8" />
		<meta name="description" content="School Management, School Registration, Learners Registration, Signup, Sign-in" />
		<meta name="keywords" content="School Management,  School Registration, Learners Registration, Signup, Sign-in" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="School Management, School Registration, Learners Registration, Signup, Sign-in" />
	...
	<body id="kt_body" class="sidebar-enabled">
		...
		<div class="d-flex flex-column flex-root">
			...
			<?php 
					...
					include_once("./asideMenu/sidebarMenu.php");
			?>
					<!--begin::Footer-->
									...
									<div class="card card-xl-stretch mb-xl-10" style="background-color: #F7D9E3">
										...
										<div class="card-body d-flex flex-column">
											...
											<div class="d-flex flex-column flex-grow-1">
												<!--begin::Title-->
												<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Total  students</a>
												<!--end::Title-->
												<!--begin::Chart-->
								...
								<div class="col-xl-4">
									...
									<div class="card card-xxl-stretch mb-xl-10" style="background-color: #CBF0F4">
										...
										<div class="card-body d-flex flex-column">
											...
											<div class="d-flex flex-column flex-grow-1">
												<!--begin::Title-->
												<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Total Number of Staff</a>
												<!--end::Title-->
												<!--begin::Chart-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-10" style="background-color: #CBD4F4">
										...
										<div class="card-body d-flex flex-column">
											...
											<div class="d-flex flex-column mb-7">
												<!--begin::Title-->
												<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Total payment recieved</a>
												<!--end::Title-->
											</div>
											<!--end::Wrapper-->
											<!--begin::Row-->
											<div class="row g-0">
												...
												<div class="col-6">
													<div class="d-flex align-items-center mb-9 me-2">
														...
														<!--begin::Title-->
														<div>
															<div class="fs-5 text-dark fw-bolder lh-1">NGN50K</div>
												...
												<div class="col-6">
													<div class="d-flex align-items-center mb-9 ms-2">
														...
														<!--begin::Title-->
														<div>
															<div class="fs-5 text-dark fw-bolder lh-1">NGN4,5K</div>
												...
												<div class="col-6">
													<div class="d-flex align-items-center me-2">
														...
														<!--begin::Title-->
														<div>
															<div class="fs-5 text-dark fw-bolder lh-1">NGN40</div>
							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 pt-5">
									...
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
										<a href="Registration/sign-up.php" class="btn btn-sm btn-light btn-active-primary">
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">WebEdu</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
