				...
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							<!--begin::Title-->
							<h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15" style="margin-bottom: 0px;">Welcome To Techyweb Africa </h1>
			
							<h3 style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">We are delighted to have you here, <br>exploring the world of development</span>
							</h3>
							<!--end::Title-->
							<!--begin::Action-->
							<a href="./Registration/sign-in.php" class="btn btn-primary">Sign in</a>
							<!--end::Action-->
						</div>
						<!--end::Heading-->
						<!--begin::Clients-->
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="fs-2 fw-bold text-muted text-center">
							<a href="../../demo3/dist/account/security.html" class="link-primary fs-4 fw-bolder">Marcus Levy,</a>
