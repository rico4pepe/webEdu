					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="title" placeholder="Subject Title--" autocomplete="off">
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Desc</label>
                                          
                                            <textarea class="form-control form-control-lg form-control-solid" name="desc"  placeholder="Subject Description--" required></textarea>
                                         
                                        </div>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Whom to send to</label>
