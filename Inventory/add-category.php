									...
									<div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden">
										...
										<form data-kt-search-element="preferences" class="pt-1 d-none">
											...
											<div class="d-flex justify-content-end pt-7">
												...
												<button type="submit" class="btn btn-sm fw-bolder btn-primary">Save Changesss</button>
											</div>
											<!--end::Actions-->
										</form>
										<!--end::Preferences-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<?php
                                    if (isset($_POST["btn"])) {
										...
										$Categories->insertCategories($category_Name, $description,  $avatar, $imgName);
                                    }
                        ?>
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" name="category_name" class="form-control mb-2" placeholder="Category name" value=""  required/>
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div>
												...
												<textarea type="text" name="desc" class="form-control mb-2" placeholder="Category Description" required> </textarea>
