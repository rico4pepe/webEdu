					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Create-Present</h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select  name="class_id"  class="form-control form-control-lg form-control-solid"  autocomplete="off">
										...
										<div class="fv-row mb-5">
                                          <label class="form-label fw-bolder text-dark fs-6"> Select Arm</label>
											<select  name="arm_id"  class="form-control form-control-lg form-control-solid"  autocomplete="off">
                                        ...
                                        <div class="col-xl-6">
										<input type="submit" name="btn" class="btn btn-lg btn-primary" value="Create Class Teacher"  />
