							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
                                        ...
                                        $notification_datetime = $_POST["notification_datetime"];

										
                                                                       
										$Notifications->insertNotifications($notification,  $notification_datetime);
                                    }
                        ?>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Notification title</label>
                                            <input  class="form-control form-control-lg form-control-solid" type="text" name="notification" autocomplete="off">
                                        </div>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Notification Date</label>
                                            <input class="form-control form-control-solid" placeholder="Pick date &amp; time" name="notification_datetime"  type="datetime-local" />
