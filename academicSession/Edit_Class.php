...
$class_id = $class_name = null;
$id = $_GET['id'];
$users_query  = $conn->query("SELECT id, class_name FROM `school_class` where id = '$id'");
$users_row = $users_query ->fetch((PDO::FETCH_ASSOC));

$class_id = $users_row['id'];
$class_name = $users_row['class_name'];
							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
										...
										$SchoolClass->updateClass($className, $id);
                                    }
                        ?>
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Class</label>
                                            <input  class="form-control form-control-lg form-control-solid" type="text" name="className" value="<?php echo $class_name; ?>" autocomplete="off">
