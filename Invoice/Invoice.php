...
{
	$counter = sizeof($_SESSION['product_name']);
	$total = 0;
	
	print_r($_SESSION['invoice_number']);
}
...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="print-content-only sidebar-enabled">
		<!--begin::Main-->
		<!--begin::Root-->
							...
							<div class="card">
								...
								<div class="card-body py-20">
									...
									<div class="mw-lg-950px mx-auto w-100">
										<!-- begin::StartIf Header-->
										<?php if (isset($_SESSION['product_name'])) {
											?>
										<div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
											<h4 class="fw-boldest text-gray-800 fs-2qx pe-5 pb-7">INVOICE : <?php echo $_SESSION['invoice_number'][0]; ?></h4>
											<!--end::Logo-->
											...
											<div class="d-flex justify-content-between flex-column flex-md-row">
												...
												<div class="flex-grow-1 pt-8 mb-13">
														...
														<table class="table">
															<thead>
																<tr class="border-bottom fs-6 fw-bolder text-muted text-uppercase">
																	...
																	<th class="min-w-70px pb-9 text-end">Item</th>
																	<th class="min-w-80px pb-9 text-end">Quantity</th>
																	<th class="min-w-100px pe-lg-6 pb-9 text-end">Price</th>
																</tr>
															</thead>
															<tbody>
															<?php for ($x = 0; $x < $counter; $x++) {
																$newStr = str_replace(',', '', $_SESSION['price'][$x]);
																$num = intval($newStr);

																$total += (float) $newStr * $_SESSION['quantity'][$x];
																?>
																<tr class="fw-bolder text-gray-700 fs-5 text-end">
																	<td class="d-flex align-items-center">
																	<i class="fa fa-genderless text-success fs-1 me-2"></i><?php echo $_SESSION['description'][$x]; ?></td>
																	<td><?php echo $_SESSION['product_name'][$x]; ?></td>
																	<td><?php echo $_SESSION['quantity'][$x]; ?></td>
																	<td class="fs-5 text-dark fw-boldest pe-lg-6"><?php echo number_format($_SESSION['price'][$x], 2); ?></td>
																</tr>
																<?php
															} ?>
													...
													<div class="d-flex flex-column mw-md-300px w-100">
														<!--begin::Label-->
														<div class="fw-bold fs-5 mb-3 text-dark00"></div>
														<!--end::Label-->
														<!--begin::Item-->
														...
														<div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
															<!--begin::Accountname-->
															<div class="fw-bold pe-5">BIll FROM:</div>
															<!--end::Accountname-->
															<!--begin::Label-->
															<div class="text-end fw-norma">Pst-Willie</div>
															<!--end::Label-->
														</div>
														...
														<div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
															<!--begin::Accountname-->
															<div class="fw-bold pe-5">INVOICE TO:</div>
															<!--end::Accountname-->
															<!--begin::Label-->
															<div class="text-end fw-norma">Iris Watson.</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
														<!--begin::Item-->
														<div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
															<!--begin::Accountnumber-->
															<div class="fw-bold pe-5">DATE:</div>
															<!--end::Accountnumber-->
															<!--begin::Number-->
															<div class="text-end fw-norma">12 May, 2020
													</div>
															<!--end::Number-->
														</div>
														<!--end::Item-->
														...
														<div class="d-flex flex-stack text-gray-800 fs-6">
															<!--begin::Code-->
															<div class="fw-bold pe-5">INVOICE NO:</div>
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">56758</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
													</div>
												...
												<div class="text-end pt-10">
													...
													<div class="fs-xl-2x fs-2 fw-boldest"><?php echo number_format($total, 2); ?></div>
										...
										<?php
												...
												?>
													<div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
											<h4 class="fw-boldest text-gray-800 fs-2qx pe-5 pb-7">INVOICE : No Item to generate an Invoice for</h4>
											<!--end::Logo-->
											<div class="text-sm-end">
												<!--begin::Logo-->
												<a href="#">
												...
												<div class="text-sm-end fw-bold fs-4 text-muted mt-7">
													<div>Schol Name</div>
													<div>School address and Telephone Number</div>
												</div>
												<!--end::Text-->
											</div>
										</div>
										...
										<div class="d-flex justify-content-between flex-column flex-md-row">
												...
												<div class="flex-grow-1 pt-8 mb-13">
													...
													<div class="table-responsive border-bottom mb-14">
														<table class="table">
															...
															<tbody>
																...
																<tr class="fw-bolder text-gray-700 fs-5 text-end">
																	<td class="d-flex align-items-center">
																	<i class="fa fa-genderless text-success fs-1 me-2"></i></td>
																	<td>Null</td>
																	<td>Null</td>
													...
													<div class="d-flex flex-column mw-md-300px w-100">
														...
														<div class="d-flex flex-stack text-gray-800 fs-6">
															...
															<!--end::Code-->
															<!--begin::Label-->
															<div class="text-end fw-norma">No Invoice Genrated Yet</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
													</div>
												...
												<div class="text-end pt-10">
													<!--begin::Total Amount-->
													<div class="fs-3 fw-bolder text-muted mb-3">TOTAL AMOUNT</div>
													<div class="fs-xl-2x fs-2 fw-boldest">0.00</div>
													<div class="text-muted fw-bold">Taxes included</div>
													<!--end::Total Amount-->
