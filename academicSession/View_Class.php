							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<!--begin::Add customer-->
										<a href="./academicSession/Create_Class.php" class="btn btn-primary">Create Class</a>
										<!--end::Add customer-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-250px">class ID</th>
										...
										<?php
											...
											$stmt = $conn->prepare("SELECT  id, class_name FROM `school_class`");
        			$stmt->execute();
											...
											<tr>
												...
												<td>
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $id;?></span>
															<!--end::Title-->
															<!--begin::Description-->
												...
												<td class="text-end">
													...
													<!--end::Svg Icon--></a>
													<!--begin Create hidden field for class id ::Menu-->
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														<div class="menu-item px-3">
                                                            <input type="hidden" value="<?php echo $id ?>" name ="class_id" />
															<a href="<?php echo './academicSession/Edit_Class.php?id='.$id; ?>" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
