		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<!--begin::Add product-->
										<a href="./Inventory/add-product.php" class="btn btn-primary">Add Product</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="text-end min-w-70px">Stock-Qty</th>
											
												<th class="text-end min-w-100px">Stock-Purchased</th>
					...
					$stmt = $conn->prepare("SELECT id, product_name, description,imageUrl,imgName, type, Unit_Price, Stock_Qty,Stock_Purchase FROM `products_table`");
        			$stmt->execute();
					...
					$stockPurchased = $row['Stock_Purchase']; 
					$currentStock = $stockQuantity - $stockPurchased;
			...
			?>
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="symbol symbol-50px">
															<span class="symbol-label" style="<?php echo 'background-image:url(uploads/' . $imgName. ')' ?>"></span>
														</div>
														<!--end::Thumbnail-->
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $row['product_name'];?></span>
												...
												<td class="text-end pe-0">
													<span class="fw-bolder"><?php echo $row['description'];?></span>
												</td>
												<!--end::SKU=-->
												<!--begin::Qty=-->
												<td class="text-end pe-0" data-order="6">
													<span class="fw-bolder"><?php echo $row['type'];?></span>
												</td>
												<!--end::Qty=-->
												<!--begin::Price=-->
												<td class="text-end pe-0">
													<span class="fw-bolder"><?php echo "NGN" . $row['Unit_Price'];?></span>
												</td>
												<!--end::Price=-->
												<!--begin::Rating-->
												...
												?>
													...
													<span class="fw-bolder text-success ms-3"><?php echo  $currentStock;?></span>
												<?php
														}else if($currentStock > 30 and  $currentStock <= 50){
															?>
														<span class="badge badge-warning">Low stock</span>
													<span class="fw-bolder text-warning ms-3"><?php echo  $currentStock;?></span>
													<?php		
														}else{
															?>
																<span class="badge badge-danger"> Critically Low stock</span>
													<span class="fw-bolder text-danger ms-3"><?php echo  $currentStock;?></span>
													<?php		
														}
												?>
												...
												<td class="text-end pe-0" data-order="Scheduled">
													<!--begin::Badges-->
													<span class="fw-bolder"><?php echo  $row['Stock_Purchase'];?></span>
													<!--end::Badges-->
												</td>
												<!--end::Status=-->
												<!--begin::Action=-->
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="<?php echo './Inventory/edit-product.php?id='.$id; ?>" class="menu-link px-3">Edit</a>
