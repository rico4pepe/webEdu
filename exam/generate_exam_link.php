							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
										...
										$url = "http://localhost/admin/exam/Start_Exam.php?$query_string";
										$exam_link = $url;
										                          
										$GenerateExamLink->generateLink($exam_link,$subject_id, $class_id,$start_time, $end_time);
                                    }
								}
                        ?>
                                        <!--begin::Heading-->
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Generate Exam Link</h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select  class="form-control form-control-lg form-control-solid" name="class_id" autocomplete="off">
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Start Date Time</label>
                                            <input type="datetime-local"  class="form-control form-control-lg form-control-solid" name="start_time" autocomplete="off">
                                            
                                          
                                        </div>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> End Date and Time</label>
                                            <input type="datetime-local"  class="form-control form-control-lg form-control-solid" name="end_time" autocomplete="off">
