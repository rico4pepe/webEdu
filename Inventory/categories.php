							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<!--begin::Add customer-->
										<a href="./Inventory/add-category.php" class="btn btn-primary">Add Category</a>
										<!--end::Add customer-->
									</div>
									<!--end::Card toolbar-->
								</div>
								...
								<div class="card-body pt-0">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<tbody class="fw-bold text-gray-600">
											<!--begin::Table row-->
										<?php
											$stmt = $conn->prepare("SELECT categories_id, category_name, description,imageUrl,imgName FROM `categories`");
        			$stmt->execute();
											...
											<tr>
												...
												<td>
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $row['category_name'];?></span>
															<!--end::Title-->
															<!--begin::Description-->
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['description'];?></div>
													<!--end::Badges-->
												</td>
												<!--end::Type=-->
												<!--begin::Action=-->
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="<?php echo './Inventory/edit-category.php?id='.$id; ?>" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
