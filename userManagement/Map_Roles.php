					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Create Role </label>
                                            <select  class="form-control form-control-lg form-control-solid" type="text" name="roles" autocomplete="off">
