...
$users_query  = $conn->query("SELECT categories_id, product_name, description,imageUrl,imgName,type,Unit_Price,Stock_Qty,Stock_Purchase FROM `products_table` where id = '$id'");
$users_row = $users_query ->fetch((PDO::FETCH_ASSOC));

$category_id = $users_row['categories_id'];
$product_name = $users_row['product_name'];
$description = $users_row['description'];
$imageUrl = $users_row['imageUrl'];
$img_Name = $users_row['imgName'];

$product_typename = $users_row['type'];
$Unit_Price = $users_row['Unit_Price'];
$Stock_Qty = $users_row['Stock_Qty'];
$Stock_Purchase = $users_row['Stock_Purchase'];

$Product = new Products();
$Categories = new Categories();


$cat_query = $conn->query("SELECT  category_name FROM `categories` where categories_id = '$category_id'");
$cat_row  = $cat_query ->fetch((PDO::FETCH_ASSOC));
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Edit Product</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<?php
                                    if (isset($_POST["btn"])) {
										...
										$Stock_Purchase = $_POST["Stock_Purchase"];
										...
										$Product->updateProducts($category, $product_name, $description,  $avatar,  $img_name, $type, $unit_price, $Stock_Qty, $Stock_Purchase, $id);
                                    }
                        ?>
							<!--begin::Form-->
							<form  class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" method="post" enctype="multipart/form-data">
								<!--begin::Aside column-->
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body text-center pt-0">
											...
											<div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="">
												...
												<div class="image-input-wrapper w-150px h-150px" style="<?php echo 'background-image: url(uploads/'.$img_Name. ')'  ?>"></div>
												...
												<div class="card card-flush py-4">
													...
													<div class="card-body pt-0">
														...
														<div class="mb-10 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" name="product_name" class="form-control mb-2" placeholder="Product name" value=<?php echo $product_name ; ?> />
															<!--end::Input--> 
															<!--begin::Description-->
														...
														<!--begin::Input group-->
															...
															<div class="mb-10 fv-row">
															<!--begin::Label-->
															<label class="required form-label">Product Details</label>
															<!--end::Label-->
															<!--begin::Input-->
															<select  name="category" class="form-control mb-2" required>
																...
																<?php $Categories->dropdownCategories(); ?>
															</select>
															<!--end::Input-->
															<!--begin::Description-->
															<div class="text-muted fs-7">A class category needs to be selected to identify the product.</div>
															<!--end::Description-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div>
															...
															<!--end::Label-->
															<textarea type="text" name="desc" class="form-control mb-2" placeholder="Category Description"><?php echo $description  ; ?> </textarea>
															<!--end::Editor-->
															<!--begin::Description-->
                                        ...
                                        <div class="card card-flush py-4">
													...
													<div class="card-body pt-0">
														...
														<div class="mb-10 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" name="type" class="form-control mb-2" placeholder="Product Type" value="<?php echo $product_typename; ?> " />
															<!--end::Input-->
															<!--begin::Description-->
														...
														<div class="mb-10 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" name="unit_price" class="form-control mb-2" placeholder="Amount" value="<?php echo $Unit_Price; ?>" />
															<!--end::Input-->
															<!--begin::Description-->
															<div class="text-muted fs-7">Enter the Unit price of product.</div>
															<!--end::Description-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														...
														<div class="mb-10 fv-row">
															...
															<div class="d-flex gap-3">
																<input type="number" name="Stock_Qty" class="form-control mb-2" placeholder="On shelf" value="<?php echo $Stock_Qty; ?>" />
																<input type="number" name="Stock_Purchase" class="form-control mb-2" placeholder="In warehouse" value="<?php echo $Stock_Purchase; ?>" />
															</div>
															<!--end::Input-->
															<!--begin::Description-->
