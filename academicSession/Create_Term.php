							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
										...
										$Terms->insertTerm($term_name);
                                    }
                        ?>
                                        <!--begin::Heading-->
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Create-Term</h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <input  class="form-control form-control-lg form-control-solid" type="text" name="term_name" autocomplete="off">
