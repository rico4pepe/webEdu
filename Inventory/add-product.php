					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<?php
                                    if (isset($_POST["btn"])) {
										...
										$Product->insertProducts($category, $product_name, $description,  $avatar,  $img_name, $type, $unit_price, $Stock_Qty, $Stock_Purchase );
                                    }
                        ?>
												...
												<div class="card card-flush py-4">
													...
													<div class="card-body pt-0">
														...
														<div>
															...
															<!--end::Label-->
															<!--begin::Editor-->
															<textarea type="text" name="desc" class="form-control mb-2" placeholder="Category Description" required> </textarea><!--end::Editor-->
															<!--begin::Description-->
												...
												<div class="card card-flush py-4">
													...
													<div class="card-body pt-0">
														...
														<div class="mb-10 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" name="type" class="form-control mb-2" placeholder="Product Type" value="" />
															<!--end::Input-->
															<!--begin::Description-->
														...
														<div class="mb-10 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" name="unit_price" class="form-control mb-2" placeholder="Amount " value="" />
															<!--end::Input-->
															<!--begin::Description-->
														...
														<div class="mb-10 fv-row">
															...
															<div class="d-flex gap-3">
																<input type="number" name="Stock_Qty" class="form-control mb-2" placeholder="On shelf" value="" />
																<input type="number" name="Stock_Purchase" class="form-control mb-2" placeholder="In warehouse" />
															</div>
															<!--end::Input-->
															<!--begin::Description-->
