					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Post Virtual Link</h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select  class="form-control form-control-lg form-control-solid" name="class" autocomplete="off" required>
                                                ...
                                                <?php $SchoolClasses->dropdownClass(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select  class="form-control form-control-lg form-control-solid" name="subject" autocomplete="off" required>
										...
										<div class="fv-row mb-5">
                                            ...
                                            <input type="text"  class="form-control form-control-lg form-control-solid kt-multiselect" name="title"  autocomplete="off" required />
										...
										<div class="fv-row mb-5">
                                            ...
                                            <input type="date"  class="form-control form-control-lg form-control-solid kt-multiselect" name="dateTime"  autocomplete="off" required />
                                               
                                        </div>

										<div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Start Time</label>
                                            
                                            <input type="time" class="form-control form-control-lg form-control-solid" name = "stime"   placeholder="Select date">
                                         
                                        </div>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> End Time</label>
                                            
                                            <input type="time" class="form-control form-control-lg form-control-solid"  name = "etime"   placeholder="Select date">
                                         
                                        </div>

                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6">Zoom/Google Link to Share</label>
                                          
                                            <input type="text"  class="form-control form-control-lg form-control-solid kt-multiselect" name="shareLink"  autocomplete="off" required />
                                        ...
                                        <div class="col-xl-6">
										<input type="submit" name="btn" class="btn btn-lg btn-primary" value="Send"  />
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							<h1 class="mb-3">Search Usersss</h1>
