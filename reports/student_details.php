				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Students Details</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5">
								<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    <td>
                                <div class="col-xl-12">
									<label class="form-label fw-bolder text-dark fs-6">Session</label>
									<select class="form-control form-control-lg form-control-solid" type="text" name="session" autocomplete="off">
								...
								<div class="col-xl-12">
									...
									<select class="form-control form-control-lg form-control-solid" type="text" name="annex" autocomplete="off">
                            ...
                            <td>
								<div class="col-xl-12">
									<label class="form-label fw-bolder text-dark fs-6">Term</label>
									<select class="form-control form-control-lg form-control-solid" type="text" name="term" autocomplete="off">
                              ...
                              <td>
                                <div class="col-xl-12">
									...
									<select class="form-control form-control-lg form-control-solid" type="text" name="class" autocomplete="off">
                                  
                                            <option value=""> Select Class</option>
											<?php $SchoolClass->dropdownClass(); ?>
									</select>
								</div></td>



								<td class="min-w-250px">	<button type="submit" name="btnReport" class="btn btn-primary" >Submit</button> </td>
							</tr>
					</table>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-xxl" id="kt_content_container">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="text-end min-w-70px">Parent Number</th>
											</tr>
											<!--end::Table row-->
										</thead>
										<!--end::Table head-->
							...
							if (isset($_POST['btnReport'])) {
                                ...
                                if($class !== ""){
                                    $clause .= ' class_id =' . $class ; 
                                }

                                if($term !== ""){
                                    $clause .= ' AND  term_id =' . $term; 
                                }
                                if($annex !== ""){
                                    $clause .= ' AND annex_id =' . $annex ; 
                                }
                                if($session !== ""){
                                    $clause .= ' AND session_id =' . $session ; 
                                }

		

				
								$stmt = $conn->prepare("SELECT  First_Name,  SurName, Sex, Date_of_birth, Guidance_phone_No 
			FROM learners_bds WHERE $clause ");
								$stmt->execute();
								while ($row_cash = $stmt->fetch(PDO::FETCH_ASSOC)) {
											...
											<tr>
												...
												<td>
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $row_cash['First_Name'] . ' ' .  $row_cash['SurName']; ?></span>
															<!--end::Title-->
															<!--begin::Description-->
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row_cash['Sex']; ?></div>
													<!--end::Badges-->
												</td>
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row_cash['Date_of_birth']; ?></div>	
													<!--end::Badges-->
												</td>
												...
												<!--begin::Action=-->
												<td class="text-end">
												<div class="text-muted fs-7 fw-bolder"><?php echo $row_cash['Guidance_phone_No']; ?></div>
													<!--end::Menu-->
												</td>
												<!--end::Action=-->
											</tr>
