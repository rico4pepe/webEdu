		...
		<div class="d-flex flex-column flex-root">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								...
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-muted">Lesson Note</li>
									<li class="breadcrumb-item text-muted">View <?php echo "User";?> Lesson Note Status</li>
								...
								<div class="card-body pt-0">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<?php
											...
											$stmt = $conn->prepare("SELECT id, Note_Tittle, Note_Description, status FROM `lesson_note`");
        			$stmt->execute();
			...
			?>
											<tr>
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['status'];?></div>
													<!--end::Badges-->
												</td>

												<td> 
												<div class="text-muted fs-7 fw-bolder"><?php echo "Hello";?></div>
												</td>
