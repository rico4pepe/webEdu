					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Create-Bus Time Table for Session 2023 and Term </h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Routes</label>
                                            <input type="text" class="form-control form-control-lg form-control-solid" name = "routes"   placeholder="Route / Destination">
                                        </div>
