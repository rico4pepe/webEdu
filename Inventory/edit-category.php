...
$category_id = $category_name = $description = $imageUrl = $imgName = null;
$users_query  = $conn->query("SELECT categories_id, category_name, description,imageUrl,imgName FROM `categories` where categories_id = '$id'");
$users_row = $users_query ->fetch((PDO::FETCH_ASSOC));

$category_id = $users_row['categories_id'];
$category_name = $users_row['category_name'];
...
// $val = "";
// $status = "";
// $category_id = $users_row['category_id'];
// $name = $users_row['name'];
// $avater = $users_row['avater'];
// $is_deleted = $users_row['is_deleted'];
?>
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Edit Category</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-muted">Edit Categories</li>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<?php
                                    if (isset($_POST["btn"])) {
										...
										$Categories->updateCategories($category_Name, $description,  $avatar, $imgName, $category_id);
                                    }
                        ?>
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div>
												...
												<!--end::Label-->
												<!--begin::Editor-->
												<textarea type="text" name="desc" class="form-control mb-2" placeholder="Category Description" required> <?php echo $description; ?></textarea>
												<!--begin::Description-->
