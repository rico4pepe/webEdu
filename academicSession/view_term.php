		...
		<div class="d-flex flex-column flex-root">
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<!--begin::Add customer-->
										<a href="./academicSession/Create_Term.php" class="btn btn-primary">Create Term</a>
										<!--end::Add customer-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-250px">Term ID</th>
										...
										<?php
											...
											$stmt = $conn->prepare("SELECT  term_id, term_name FROM `school_term`");
        			$stmt->execute();
			...
			?>
											<tr>
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['term_name'];?></div>
													<!--end::Badges-->
												</td>
