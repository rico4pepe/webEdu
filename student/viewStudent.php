...
if(isset($_GET['id'])) {
	...
	$users_query  = $conn->query("SELECT * FROM  learners_bd WHERE ID = $id");
...
$Second_Name = $users_row['Second_Name'];

$SurName = $users_row['SurName'];
$Guidance_Email = $users_row['Guidance_Email'];
$Guidance_phone_No = $users_row['Guidance_phone_No'];
$Address = $users_row['Address'];
$State_Of_origin = $users_row['State_Of_origin'];


$Blood_Group = $users_row['Blood_Group'];
$Geno_Type = $users_row['Geno_Type'];
$Guidance_Occupation = $users_row['Guidance_Occupation'];

$student_unique_id = $users_row['student_unique_id'];
							...
							<div class="d-flex flex-column flex-lg-row">
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-body">
											...
											<div class="d-flex flex-center flex-column py-5">
												...
												<!--end::Avatar-->
												<!--begin::Name-->
												<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3"><?php echo $First_Name . " " . $Second_Name . " " . $SurName ; ?></a>
												<!--end::Name-->
												<!--begin::Position-->
											...
											<div id="kt_user_view_details" class="collapse show">
												<div class="pb-5 fs-6">
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">Student ID</div>
													<div class="text-gray-600"><?php echo $student_unique_id ?></div>
													<!--begin::Details item-->
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">Guardian Email</div>
													<div class="text-gray-600">
														<a href="#" class="text-gray-600 text-hover-primary"><?php echo $Guidance_Email; ?></a>
													</div>
													<!--begin::Details item-->
													<!--begin::Details item-->
													...
													<!--begin::Details item-->
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">Guardian Phone-No</div>
													<div class="text-gray-600"><?php echo $Guidance_phone_No; ?></div>


													
													<div class="fw-bolder mt-5">State Of origin</div>
													<div class="text-gray-600"><?php echo $State_Of_origin; ?></div>

													<div class="fw-bolder mt-5">Blood Group</div>
													<div class="text-gray-600"><?php echo $Blood_Group; ?></div>
													<!--begin::Details item-->
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">Geno Type</div>
													<div class="text-gray-600"><?php echo $Geno_Type;?></div>

                                                    <div class="fw-bolder mt-5">Guidance Occupation</div>
													<div class="text-gray-600"><?php echo $Guidance_Occupation;?></div>
													<!--begin::Details item-->
												</div>
											</div>
											<!--end::Details content-->
								...
								<div class="flex-lg-row-fluid ms-lg-15">
									...
									<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
										...
										<!--begin:::Tab item-->
										<!-- <li class="nav-item">
											<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security">Securityssss</a>
										</li> -->
										<!--end:::Tab item-->
										<!--begin:::Tab item-->
										<li class="nav-item">
				...
				<div class="card-body" id="kt_engage_demos_body">
					...
					<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
						...
						<div class="mb-0">
							...
							<!--end::License-->
							<!--begin::Purchase-->
							<a href="https://1.envato.market/EA4JP" class="btn btn-primary mb-15 w-100"></a>
							<!--end::Purchase-->
							<!--begin::Demos-->
							<div class="mb-0">
