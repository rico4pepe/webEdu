					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">View <?php echo $username; ?> Exam Question</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Staff Exam List</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<form action="" method="post">
                                            ...
                                            <select  class="form-control form-control-solid" name="class_id" id = "class_id" autocomplete="off">
                                                <option value = ""> Select Class </option>
												<?php $fetchClass->fetchDropdownClassByUser($session_id); ?>
											</select>
                                        </div>
                                            <div class="fv-row mb-5">
                                
                                <select  class="form-control  form-control-solid" name="subject_id" id = "subject_id" autocomplete="off">
                                    <option value = ""> Select Subject </option> 
                                 <?php	 $fetchClass->fetchDropdownSubjectByUser($session_id); ?>
                                </select>
                            </div>
											<!--end::Export-->
											<!--begin::Add user-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">option_a</th>
												<th class="min-w-125px">option_b</th>
												<th class="min-w-125px">option_c</th>
												
												<th class="min-w-125px">option_d</th>
												<th class="text-end min-w-100px">option_e</th>
                                                <th class="text-end min-w-100px">correct_options</th>
										...
										<tbody class="text-gray-600 fw-bold">
											...
											if(isset($_POST['btn'])){
												...
												$stmt = $conn->prepare("SELECT question_id, question_text, option_a, option_b, option_c, option_e, correct_question FROM `question_answer` 
												where class_id = :ci AND subject_id = :si and user_id = :ud");
												$stmt->bindValue(":ci", $class_id, PDO::PARAM_STR);
												$stmt->bindValue(":si", $subject_id, PDO::PARAM_STR);
												$stmt->bindValue(":ud", $session_id, PDO::PARAM_STR);
        									$stmt->execute();
											...
											<tr>
												...
												<td class="d-flex align-items-center">
													...
													<!--begin::User details-->
													<div class="d-flex flex-column">
														<div class="text-gray-800 text-hover-primary mb-1"><?php echo   $row['question_text'] ?></div>
												...
												<!--begin::Last login=-->
												<td>
													<div class="badge badge-light fw-bolder"><?php echo $row['option_b']; ?></div>
												</td>
												<td>
													<div class="badge badge-light fw-bolder"><?php echo $row['option_c']; ?></div>
												</td>
												<!--end::Last login=-->
												<!--begin::Two step=-->
												<td>
													<div class="badge badge-light-success fw-bolder"><?= isset($row['option_d']) ? $row['option_d'] : '' ?></div>
												</td>
                                                <td>
													<div class="badge badge-light-success fw-bolder"><?= isset($row['option_e']) ? $row['option_e'] : '' ?></div>
												</td>
                                                <td>
													<div class="badge badge-light-success fw-bolder"><?php echo   $row['correct_question']; ?></div>
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="<?php echo './userManagement/viewStaffExam.php?id='.urlencode($question_id) ; ?>" class="menu-link px-3">View</a>
				...
				<div class="card-body" id="kt_engage_demos_body">
					...
					<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
						...
						<div class="mb-0">
							...
							<!--end::License-->
							<!--begin::Purchase-->
							<a href="https://1.envato.market/EA4JP" class="btn btn-primary mb-15 w-100">Buyxy Now</a>
							<!--end::Purchase-->
							<!--begin::Demos-->
							<div class="mb-0">
