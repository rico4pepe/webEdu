				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Transaction Details</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" >
                                ...
                                <div class="col-xl-12">
									...
									<select class="form-control form-control-lg form-control-solid" type="text" name="first-name" autocomplete="off">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-xxl" id="kt_content_container">
							...
							if (isset($_POST['btnReport'])) {
								...
								$total_transaction_query = $conn->query("SELECT sum(product_price) as total from  invoicepayment where payment_date  BETWEEN '$startdate' and '$enddate'");
								$total_row = $total_transaction_query->fetch((PDO::FETCH_ASSOC));


								$total = $total_row['total'];

								
								$stmt = $conn->prepare("SELECT  product_name,  description, product_qty, product_price 
			FROM invoicepayment WHERE payment_date  BETWEEN '$startdate' and '$enddate' ");
								$stmt->execute();
											...
											<tr>
												...
												<td>
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $row_cash['product_name']; ?></span>
															<!--end::Title-->
															<!--begin::Description-->
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row_cash['description']; ?></div>
													<!--end::Badges-->
												</td>
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row_cash['product_qty']; ?></div>	
													<!--end::Badges-->
												</td>
												...
												<!--begin::Action=-->
												<td class="text-end">
												<div class="text-muted fs-7 fw-bolder"><?php echo number_format($row_cash['product_price'], 2); ?></div>
													<!--end::Menu-->
												</td>
												<!--end::Action=-->
											</tr>
