				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Days</label>
                                            <select  class="form-control form-control-lg form-control-solid" name="days" autocomplete="off" required>
                                                <option value=""> Select Day</option>
                                                <?php $Days ->dropdownDays(); ?>
                                            </select>
                                        </div>


                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6">Facilitator</label>
                                            <select  class="form-control form-control-lg form-control-solid" name="facilitator" autocomplete="off" required>
                                        ...
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Date of exam</label>
