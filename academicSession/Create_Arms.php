						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="card">
								...
								<div class="card-body py-4">
									...
									<?php
                                    if (isset($_POST["btn"])) {
                                        $arms_name = $_POST["arms_name"];

										
                                                                       
										$Arm->insertArms($arms_name);
                                    }
                        ?>
                                        <!--begin::Heading-->
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-dark mb-3">Create-Arm</h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <input   class="form-control form-control-lg form-control-solid" type="text" name="arms_name" autocomplete="off">
