...
$toClass = new Staff();
$result = $staffClass->getClassTeacher($session_id, $school_session_id, $term_id );

$class_result = $toClass->staff_classroom($result['class_id'], $result['arm_id'],$result['annex_id'], $school_session_id, $term_id);
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								...
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">My Class</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">Guidance mail</th>
											...
											<tr>
												...
												<td class="d-flex align-items-center">
													...
													<div class="d-flex flex-column">
														<div class="text-gray-800 text-hover-primary mb-1"><?php echo   $row['First_Name'] . " " . $row['Second_Name']; ?></div>
												...
												<!--begin::Last login=-->
												<td>
													<div class="badge badge-light fw-bolder"><?php echo   $row['Sex']; ?></div>
												</td>
												<!--end::Last login=-->
												<!--begin::Two step=-->
												<td>
													<div class="badge badge-light-success fw-bolder"><?php echo   $row['imageUrl']; ?></div>
												</td>

												
												<!--end::Two step=-->
												<!--begin::Joined-->
												<td><?php echo   $row['Guidance_Email']; ?></td>
												<!--begin::Joined-->
												<!--begin::Action=-->
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="<?php echo './exam/student_class_exam_rec.php?id='.urlencode($student_id) ; ?>" class="menu-link px-3">Enter Student Class Record</a>
