...
$annex_id = $annex_name = null;
$id = $_GET['id'];
$users_query  = $conn->query("SELECT id, annex_name FROM `annex` where id = '$id'");
$users_row = $users_query ->fetch((PDO::FETCH_ASSOC));

$annex_id = $users_row['id'];
							...
							<div class="card">
								...
								<div class="card-body py-4">
                                    ...
                                    if (isset($_POST["btn"])) {
										...
										$Annexes->updateAnnex($annexName, $id);
                                    }
                        ?>
                                        <div class="fv-row mb-5">
                                            <label class="form-label fw-bolder text-dark fs-6"> Annex</label>
                                            <input  class="form-control form-control-lg form-control-solid" type="text" name="annexName" value="<?php echo $annex_name; ?>" autocomplete="off">
