		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								...
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-muted">View Lesson Note</li>
						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="card card-flush">
								...
								<div class="card-body pt-0">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-150px">Note Description</th>
									...
									// $cachedLessonNote = $client->get('lessonNote');
									// if($cachedLessonNote){
									// 	//Display result from cache
									// 	echo "Coming from redis , <br />";
									// 	echo $cachedLessonNote;

									// }else{
                                        
											$stmt = $conn->prepare("SELECT id, Note_Tittle, Note_Description FROM `lesson_note`");
        			$stmt->execute();
	                                        $temp = '';
            		...
            		$id = $row['id'];
					$temp .= $row['id'] . '<br />'; 
					$temp .= $row['Note_Tittle'] . '<br />';
					$temp .= $row['Note_Description'] . '<br />';
			...
			?>
											<tr>
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['Note_Description'];?></div>
													<!--end::Badges-->
												</td>
									...
									// 	$client->set('lessonNote', $temp);
									// 	$client->expire('lessonNote', 10);
									// }
										?>
											<!--end::Table row-->
											<!--begin::Table row-->
