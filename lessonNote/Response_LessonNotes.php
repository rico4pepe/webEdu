					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Lesson Notes</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-muted"> Admin View Lesson Note</li>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-250px">Note Tittle</th>
										...
										<?php
											...
											$stmt = $conn->prepare("SELECT lesson_note.id , lesson_note.Note_Tittle,lesson_note.created_by, school_class.class_name as class_name, subjects.Name as subject_name FROM school_class INNER JOIN lesson_note ON trim(lesson_note.Class_id) = trim(school_class.id) INNER JOIN subjects ON trim(lesson_note.subject_id) = trim(subjects.id) WHERE status = 'Review' ");
        			$stmt->execute();
											...
											<tr>
												...
												<td>
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<span class="fw-bolder"><?php echo $row['Note_Tittle'];?></span>
															<!--end::Title-->
															<!--begin::Description-->
												...
												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['created_by']; ;?></div>
													<!--end::Badges-->
												</td>

												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['subject_name'];?></div>
													<!--end::Badges-->
												</td>

												<td>
													<!--begin::Badges-->
													<div class="text-muted fs-7 fw-bolder"><?php echo $row['class_name'];?></div>
													<!--end::Badges-->
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="<?php echo './lessonNote/LessonNote_View.php?id='.$id; ?>" class="menu-link px-3">View</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
